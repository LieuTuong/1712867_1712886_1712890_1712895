...
//ham chuyen tung ki tu cua he 16 sang he 2 tuong ung
...
{
	string a = A, b = B;
	if (a.length() < MAX) a.insert(0, MAX - a.length(), '0');
	if (b.length() < MAX) b.insert(0, MAX - b.length(), '0');
...
//Ham kiem tra day bit do co la so am hay khong
